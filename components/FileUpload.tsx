        ...
        <div className="flex flex-col items-center justify-center pt-5 pb-6">
          {isLoading ? (
            ...
            <>
              ...
              <p className="text-base text-zinc-400">Archivo Excel (.xlsx, .xls)</p>
            </>
          )}
        </div>
        <input id="dropzone-file" type="file" className="hidden" onChange={handleChange} accept=".xlsx, .xls" disabled={isLoading} />
      </label>
    </div>
  );
};