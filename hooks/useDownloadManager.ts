...
export const useDownloadManager = () => {
    ...
    useEffect(() => {
        // Fetch tasks only when authentication is complete and we have a user
    ...
    }, [currentUser, isAuthLoading, fetchTasks]);
    ...
    const updateTaskOnSheetAndState = async (updatedTask: DownloadTask) => {
        ...
        try {
            ...
            alert("Error: No se pudo guardar el cambio en la base de datos. Por favor, recargue la página.");
